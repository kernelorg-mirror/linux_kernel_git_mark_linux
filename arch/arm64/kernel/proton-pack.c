...
static enum mitigation_state spectre_v2_get_cpu_hw_mitigation_state(void)
{
	...
	static const struct midr_range spectre_v2_safe_list[] = {
		MIDR_RANGE_ALL(ARM, CORTEX_A35),
		MIDR_RANGE_ALL(ARM, CORTEX_A53),
		MIDR_RANGE_ALL(ARM, CORTEX_A55),
		MIDR_RANGE_ALL(BRCM, BRAHMA_B53),
		MIDR_RANGE_ALL(HISI, TSV110),
		MIDR_RANGE_ALL(QCOM, KRYO_2XX_SILVER),
		MIDR_RANGE_ALL(QCOM, KRYO_3XX_SILVER),
		MIDR_RANGE_ALL(QCOM, KRYO_4XX_SILVER),
		{ /* sentinel */ }
	};
...
static bp_hardening_cb_t spectre_v2_get_sw_mitigation_cb(void)
{
	...
	if (((midr & MIDR_CPU_MODEL_MASK) != MIDR_MODEL(QCOM, FALKOR)) &&
	    ((midr & MIDR_CPU_MODEL_MASK) != MIDR_MODEL(QCOM, FALKOR_V1)))
		return NULL;
...
static bool is_spectre_bhb_safe(int scope)
{
	static const struct midr_range spectre_bhb_safe_list[] = {
		...
		MIDR_RANGE_ALL(ARM, CORTEX_A520),
		MIDR_RANGE_ALL(BRCM, BRAHMA_B53),
		MIDR_RANGE_ALL(QCOM, KRYO_2XX_SILVER),
		MIDR_RANGE_ALL(QCOM, KRYO_3XX_SILVER),
		MIDR_RANGE_ALL(QCOM, KRYO_4XX_SILVER),
...
static u8 spectre_bhb_loop_affected(void)
{
	...
	static const struct midr_range spectre_bhb_k32_list[] = {
		...
		MIDR_RANGE_ALL(ARM, CORTEX_A78AE),
	...
	static const struct midr_range spectre_bhb_k24_list[] = {
		...
		MIDR_RANGE_ALL(ARM, CORTEX_A76AE),
		MIDR_RANGE_ALL(ARM, CORTEX_A77),
		MIDR_RANGE_ALL(ARM, NEOVERSE_N1),
		MIDR_RANGE_ALL(QCOM, KRYO_4XX_GOLD),
		MIDR_RANGE_ALL(HISI, HIP09),
		{},
	};
