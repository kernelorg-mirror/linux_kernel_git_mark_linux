...
static enum mitigation_state spectre_v2_get_cpu_hw_mitigation_state(void)
{
	...
	static const struct midr_range spectre_v2_safe_list[] = {
		MIDR_RANGE_ALL(MIDR_CORTEX_A35),
		MIDR_RANGE_ALL(MIDR_CORTEX_A53),
		MIDR_RANGE_ALL(MIDR_CORTEX_A55),
		MIDR_RANGE_ALL(MIDR_BRAHMA_B53),
		MIDR_RANGE_ALL(MIDR_HISI_TSV110),
		MIDR_RANGE_ALL(MIDR_QCOM_KRYO_2XX_SILVER),
		MIDR_RANGE_ALL(MIDR_QCOM_KRYO_3XX_SILVER),
		MIDR_RANGE_ALL(MIDR_QCOM_KRYO_4XX_SILVER),
		{ /* sentinel */ }
	};
...
static bool is_spectre_bhb_safe(int scope)
{
	static const struct midr_range spectre_bhb_safe_list[] = {
		...
		MIDR_RANGE_ALL(MIDR_CORTEX_A520),
		MIDR_RANGE_ALL(MIDR_BRAHMA_B53),
		MIDR_RANGE_ALL(MIDR_QCOM_KRYO_2XX_SILVER),
		MIDR_RANGE_ALL(MIDR_QCOM_KRYO_3XX_SILVER),
		MIDR_RANGE_ALL(MIDR_QCOM_KRYO_4XX_SILVER),
...
static u8 spectre_bhb_loop_affected(void)
{
	...
	static const struct midr_range spectre_bhb_k32_list[] = {
		...
		MIDR_RANGE_ALL(MIDR_CORTEX_A78AE),
	...
	static const struct midr_range spectre_bhb_k24_list[] = {
		...
		MIDR_RANGE_ALL(MIDR_CORTEX_A76AE),
		MIDR_RANGE_ALL(MIDR_CORTEX_A77),
		MIDR_RANGE_ALL(MIDR_NEOVERSE_N1),
		MIDR_RANGE_ALL(MIDR_QCOM_KRYO_4XX_GOLD),
		MIDR_RANGE_ALL(MIDR_HISI_HIP09),
		{},
	};
