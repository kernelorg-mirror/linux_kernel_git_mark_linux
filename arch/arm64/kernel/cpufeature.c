				...
				int scope)
{
	...
	static const struct midr_range kpti_safe_list[] = {
		...
		MIDR_RANGE_ALL(ARM, CORTEX_A73),
		MIDR_RANGE_ALL(HISI, TSV110),
		MIDR_RANGE_ALL(NVIDIA, CARMEL),
		MIDR_RANGE_ALL(QCOM, KRYO_2XX_GOLD),
...
static bool cpu_has_broken_dbm(void)
{
	...
	static const struct midr_range cpus[] = {
		...
		MIDR_RANGE(ARM, CORTEX_A510, 0, 0, 0, 2),
#endif
		{},
	};
...
bool cpu_supports_bbml2_noabort(void)
{
	...
	static const struct midr_range supports_bbml2_noabort_list[] = {
		MIDR_RANGE(ARM, CORTEX_X4, 0, 3, 0, 0xf),
		MIDR_RANGE(ARM, NEOVERSE_V3, 0, 2, 0, 0xf),
		MIDR_RANGE(ARM, NEOVERSE_V3AE, 0, 2, 0, 0xf),
		MIDR_RANGE_ALL(NVIDIA, OLYMPUS),
