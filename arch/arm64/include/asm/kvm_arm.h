 ...
 *   [8]	RES0		-> ???
 */
#define __KVM_HDFGRTR_EL2_pMASK	(BIT(63) | GENMASK(58, 50) | GENMASK(48, 43) | \
				 GENMASK(41, 40) | GENMASK(37, 22) | \
				 GENMASK(19, 9) | GENMASK(7, 0))
#define __KVM_HDFGRTR_EL2_nMASK	(UL(0))	// TODO
#define __KVM_HDFGRTR_EL2_RES0	~(__KVM_HDFGRTR_EL2_pMASK | __KVM_HDFGRTR_EL2_nMASK)

#define __KVM_HDFGWTR_EL2_pMASK	(GENMASK(57, 52) | GENMASK(50, 48) | \
				 GENMASK(46, 44) | GENMASK(42, 41) | \
				 GENMASK(37, 35) | GENMASK(33, 31) | \
				 GENMASK(29, 23) | GENMASK(21, 10) | \
				 GENMASK(8, 7) | GENMASK(5, 0))
#define __KVM_HDFGWTR_EL2_nMASK	(UL(0))	// TODO
