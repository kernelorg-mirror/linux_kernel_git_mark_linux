...
under ``-std=gnu99`` [gcc-c-dialect-options]_: the GNU dialect of ISO C99.
``clang`` [clang]_ is also supported, see docs on :ref:`Building Linux with
Clang/LLVM <kbuild_llvm>`.
